    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_order', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='dbms.InceptionWorkOrderInfo', to_field='work_order_id')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('r_time', models.DateTimeField(auto_now_add=True)),
                ('back_pool_id', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='dbms.BackupPoolInfo')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='work_order',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='dbms.InceptionWorkOrderInfo', to_field='work_order_id'),
        ),
        migrations.AddField(
            model_name='backupedinfo',
            name='machine_id',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='dbms.MysqlBackupSourceInfo'),
        ),
        migrations.AddField(
